...
//  
//
//  Created by Chip Jarred on 8/26/20.
//
...
// -------------------------------------
class DivideKnuthD_UnitTests: XCTestCase
{
    ...
    // -------------------------------------
    func dumpitToString<T: RandomAccessCollection>(_ msg: String, _ n: Int, _ v: T)
        -> String
        where T.Element == UInt32, T.Index == Int
    {
        var s = msg

        for value in v.reversed() {
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_produces_0_quotient_and_remainder_when_dividing_0_by_non_zero() throws
    {
        ...
        for testCase in testCases
        {
            ...
            XCTAssertEqual(
                q,
                cq,
                dumpitToString("Error, dividend u =", m, u)
                + dumpitToString("       divisor  v =", n, v)
                + dumpitToString("For quotient,  got:", m-n+1, q)
                + dumpitToString("        Should get:", m-n+1, cq)
            )
            ...
            XCTAssertEqual(
                ...
                dumpitToString("Error, dividend u =", m, u)
                + dumpitToString("       divisor  v =", n, v)
                + dumpitToString("For remainder, got:", n, r)
                + dumpitToString("        Should get:", n, cr)
            )
        }
    }
    
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_produces_quotient_1_and_remainder_0_when_dividing_nonzero_number_by_itself() throws
    {
        var testCases: [TestCase] =
        [
            TestCase(
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_produces_quotient_same_as_dividend_and_remainder_0_when_dividing_nonzero_number_by_1() throws
    {
        var testCases: [TestCase] =
        [
            TestCase(
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_produces_quotient_1s_corresponding_to_each_dividend_digit_and_remainder_0_when_dividend_consists_of_repeating_digit_and_divisor_is_that_digit() throws
    {
        var testCases: [TestCase] =
        [
            TestCase(
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_produces_quotient_0_remainder_same_as_dividend_when_divisor_is_greater_than_dividend() throws
    {
        var testCases: [TestCase] =
        [
            TestCase(
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_miscellaneous_common_cases() throws
    {
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_first_estimated_quotient_digit_can_be_larger_than_the_radix() throws
    {
        let testCases: [TestCase] =
        [
            TestCase(
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_cases_when_adding_back_to_remainder_and_decrementing_quotient_digit_is_required() throws
    {
        let testCases: [TestCase] =
        [
            TestCase(
    ...
    // -------------------------------------
    func test_fullWidthDivide_KnuthD_results_of_multiply_and_subtract_for_intermediate_remainder_cannot_be_treated_as_signed() throws
    {
        let testCases: [TestCase] =
        [
            TestCase(
