//
//  WideUInt_Multiplication_SchoolBook2_UnitTests.swift
//
//
...
// -------------------------------------
class WideUInt_Multiplication_SchoolBook2_UnitTests: WideUInt_Multiplication_UnitTests
{
    ...
    {
        return x.multipliedFullWidth_schoolbook2(by: y)
    }
}
